...
public class FruitQuiz extends KeyAdapter {
	...
	void makeQuestions() {
		...
		question2 = new JLabel("<html>What is not a shape?  <br> A: Circle <br> B: Pizza <br> C: Triangle</html>");
		question3= new JLabel ("<html>What is the color of the sky when it rains? <br> A:Blue <br> B:Grey <br> C: White</html>");
		question4= new JLabel("<html>What How old is Nancy? <br> A: 14 <br> B:15 <br> C:13</html>");
	}
